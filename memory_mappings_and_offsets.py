...
Gametype_Name_Address = 0x2FBA80                 # Will update after gametype is selected in menu
Gametype_Name_Address_2 = 0x2FBEEC               # Will update after gametype is selected in menu
